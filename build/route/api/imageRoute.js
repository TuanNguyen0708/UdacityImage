...
imageRoute.get('/api/image', function (req, response) { return __awaiter(void 0, void 0, void 0, function () {
    var request, width, height, result, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, imageFile_1.default)(request.filename, width, height)];
            case 1:
                result = _b.sent();
                if (result.length < 1) {
                    response.send({
